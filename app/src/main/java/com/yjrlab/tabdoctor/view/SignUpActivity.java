...
import com.yjrlab.tabdoctor.TapDoctorActivity;
...
public class SignUpActivity extends TapDoctorActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonOk:
                if (!checkableButton1.isChecked() || !checkableButton2.isChecked()) {
                    DialogDefault.showDlg(getContext(), "약관 동의를 전부 체크해주세요.", new DialogDefault.DismissListener() {
                        @Override
            ...
            case R.id.buttonOk2:
                ...
                if (job.equals("")) {
                    DialogDefault.showDlg(getContext(), "직업을 체크해주세요.", new DialogDefault.DismissListener() {
                        @Override
                        public void onDismiss() {
                        }
                    });
                ...
                if (age.equals("")) {
                    DialogDefault.showDlg(getContext(), "나이를 체크해주세요.", new DialogDefault.DismissListener() {
                        @Override
                        public void onDismiss() {
                        }
                    });
