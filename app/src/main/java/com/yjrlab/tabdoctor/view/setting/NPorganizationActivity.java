...
public class NPorganizationActivity extends TapDoctorActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.buttonOk:
                if (!checkableButton.isChecked()) {
                    DialogDefault.showDlg(getContext(), "개인정보 제3자 제공을 체크해주세요.", new DialogDefault.DismissListener() {
                        @Override
