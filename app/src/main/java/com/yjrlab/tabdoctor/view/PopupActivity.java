...
import com.yjrlab.tabdoctor.service.TapDoctorFCMService;

import java.util.List;


public class PopupActivity extends TapDoctorActivity implements View.OnClickListener {
    ...
    private void cancelNotification() {
        ((NotificationManager) getSystemService(NOTIFICATION_SERVICE)).cancel(TapDoctorFCMService.NOTIFICATION_ID);
    }
